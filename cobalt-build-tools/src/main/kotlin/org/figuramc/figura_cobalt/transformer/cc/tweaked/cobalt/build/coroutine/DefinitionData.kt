...
private val builtinMethods = run {
	val opHelper = "org/figuramc/figura_cobalt/org/squiddev/cobalt/OperationHelper"
	val dispatch = "org/figuramc/figura_cobalt/org/squiddev/cobalt/function/Dispatch"
	...
	mapOf(
		Desc("org/figuramc/figura_cobalt/org/squiddev/cobalt/compiler/InputReader", "read", "()I") to YieldType.Resume,
		Desc("org/figuramc/figura_cobalt/org/squiddev/cobalt/unwind/SuspendedFunction", "call", "(Lorg/figuramc/figura_cobalt/org/squiddev/cobalt/LuaState;)Ljava/lang/Object;") to YieldType.Resume,
