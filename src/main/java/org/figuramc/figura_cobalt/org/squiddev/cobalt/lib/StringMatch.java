...
import org.figuramc.figura_cobalt.org.squiddev.cobalt.function.VarArgFunction;
...
import static org.figuramc.figura_cobalt.org.squiddev.cobalt.lib.StringLib.L_ESC;
...
class StringMatch {
	 ...
	 */
	static Varargs find(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
	 ...
	 */
	static Varargs gmatch(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
	 ...
	 * --> x="lua-5.1.tar.gz"
	 */
	static Varargs gsubRun(LuaState state, GSubState gsub, Varargs result) throws LuaError, LuaUncatchableError, UnwindThrowable {
	 ...
	 */
	static Varargs match(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
	 ...
	 */
	private static Varargs str_find_aux(LuaState state, Varargs args, boolean find) throws LuaError, LuaUncatchableError {
	...
	static class GMatchAux extends VarArgFunction {
		...
		@Override
		protected Varargs invoke(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
	...
	static final class GSubState {
		...
		GSubState(LuaState state, LuaString src, LuaString pattern, LuaValue replace, int maxS) throws LuaUncatchableError {
	...
	static class MatchState {
		...
		private void add_s(Buffer lbuf, LuaString news, int soff, int e) throws LuaError, LuaUncatchableError {
			int l = news.length();
			for (int i = 0; i < l; ++i) {
		...
		public void add_value(LuaState state, Buffer lbuf, int soffset, int end, LuaValue repl) throws LuaError, LuaUncatchableError, UnwindThrowable {
			LuaValue replace;
			switch (repl.type()) {
		...
		public void finishAddValue(Buffer lbuf, int soffset, int end, LuaValue repl) throws LuaError, LuaUncatchableError {
			if (!repl.toBoolean()) {
		...
		Varargs push_captures(boolean wholeMatch, int soff, int end) throws LuaError, LuaUncatchableError {
		...
		private LuaValue push_onecapture(int i, int soff, int end) throws LuaError, LuaUncatchableError {
			if (i >= this.level) {
				if (i == 0) {
		...
		private int check_capture(int l) throws LuaError, LuaUncatchableError {
			l -= '1';
		...
		private int capture_to_close() throws LuaError, LuaUncatchableError {
		...
		int classend(int poffset) throws LuaError, LuaUncatchableError {
		 ...
		 */
		int match(int soffset, int poffset) throws LuaError, LuaUncatchableError {
			while (true) {
		...
		int max_expand(int soff, int poff, int ep) throws LuaError, LuaUncatchableError {
			int i = 0;
		...
		int min_expand(int soff, int poff, int ep) throws LuaError, LuaUncatchableError {
			for (; ; ) {
		...
		int start_capture(int soff, int poff, int what) throws LuaError, LuaUncatchableError {
			int res;
			int level = this.level;
		...
		int end_capture(int soff, int poff) throws LuaError, LuaUncatchableError {
		...
		int match_capture(int soff, int l) throws LuaError, LuaUncatchableError {
			l = check_capture(l);
			int len = clen[l];
		...
		int matchbalance(int soff, int poff) throws LuaError, LuaUncatchableError {
