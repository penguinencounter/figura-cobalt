...
import static org.figuramc.figura_cobalt.org.squiddev.cobalt.debug.DebugFrame.FLAG_FRESH;
...
public final class Dispatch {
	...
	public static LuaValue call(LuaState state, LuaValue function) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return call(state, function, -1);
	}

	public static LuaValue call(LuaState state, LuaValue function, int stack) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return function instanceof LuaFunction func
			? callImpl(state, func)
			: callImpl(state, getCallMetamethod(state, function, stack), function);
	}

	public static LuaValue call(LuaState state, LuaValue function, LuaValue arg) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return call(state, function, arg, -1);
	}

	public static LuaValue call(LuaState state, LuaValue function, LuaValue arg, int stack) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return function instanceof LuaFunction func
			? callImpl(state, func, arg)
			: callImpl(state, getCallMetamethod(state, function, stack), function, arg);
	}

	public static LuaValue call(LuaState state, LuaValue function, LuaValue arg1, LuaValue arg2) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return call(state, function, arg1, arg2, -1);
	}

	public static LuaValue call(LuaState state, LuaValue function, LuaValue arg1, LuaValue arg2, int stack) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return function instanceof LuaFunction func
	...
	public static LuaValue call(LuaState state, LuaValue function, LuaValue arg1, LuaValue arg2, LuaValue arg3) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return call(state, function, arg1, arg2, arg3, -1);
	}

	public static LuaValue call(LuaState state, LuaValue function, LuaValue arg1, LuaValue arg2, LuaValue arg3, int stack) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return function instanceof LuaFunction func
	...
	public static Varargs invoke(LuaState state, LuaValue function, Varargs args) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return invoke(state, function, args, -1);
	}

	public static Varargs invoke(LuaState state, LuaValue function, Varargs args, int stack) throws LuaError, LuaUncatchableError, UnwindThrowable {
		return function instanceof LuaFunction func
			? invokeImpl(state, func, args)
			: invokeImpl(state, getCallMetamethod(state, function, stack), ValueFactory.varargsOf(function, args));
	}

	private static LuaValue callImpl(LuaState state, LuaFunction function) throws UnwindThrowable, LuaError, LuaUncatchableError {
	...
	private static LuaValue callImpl(LuaState state, LuaFunction function, LuaValue arg1) throws UnwindThrowable, LuaError, LuaUncatchableError {
		DebugState ds = DebugState.get(state);
		DebugFrame di = ds.pushJavaInfo();
	...
	private static LuaValue callImpl(LuaState state, LuaFunction function, LuaValue arg1, LuaValue arg2) throws UnwindThrowable, LuaError, LuaUncatchableError {
		DebugState ds = DebugState.get(state);
		DebugFrame di = ds.pushJavaInfo();
	...
	private static LuaValue callImpl(LuaState state, LuaFunction function, LuaValue arg1, LuaValue arg2, LuaValue arg3) throws UnwindThrowable, LuaError, LuaUncatchableError {
		DebugState ds = DebugState.get(state);
		DebugFrame di = ds.pushJavaInfo();
	...
	private static Varargs invokeImpl(LuaState state, LuaFunction function, Varargs args) throws UnwindThrowable, LuaError, LuaUncatchableError {
		DebugState ds = DebugState.get(state);
		DebugFrame di = ds.pushJavaInfo();
	...
	public static Varargs invokeFrame(LuaState state, DebugFrame frame) throws UnwindThrowable, LuaError, LuaUncatchableError {
	 ...
	 */
	public static LuaFunction getCallMetamethod(LuaState state, LuaValue value, int stack) throws LuaError, LuaUncatchableError {
