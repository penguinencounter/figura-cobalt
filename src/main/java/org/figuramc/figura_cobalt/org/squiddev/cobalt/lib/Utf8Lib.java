...
import static org.figuramc.figura_cobalt.org.squiddev.cobalt.Constants.NONE;
...
public final class Utf8Lib {
	...
	private Varargs codes(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
		return varargsOf(codesIter, args.arg(1).checkLuaString(state), LuaInteger.valueOf(0));
	}

	private static Varargs codepoint(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
	...
	private static Varargs len(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
		LuaString s = args.arg(1).checkLuaString(state);
		int len = s.length();
	...
	private static LuaValue offset(LuaState state, LuaValue arg1, LuaValue arg2, LuaValue arg3) throws LuaError, LuaUncatchableError {
	 ...
	 */
	private static Varargs codesIter(LuaState state, Varargs args) throws LuaError, LuaUncatchableError {
